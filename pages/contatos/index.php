                ...
                <form action="acao.php" method="post">
                    ...
                    <div class='row'>
                                ...
                                <?php
                                    ...
                                    while($linha=$consulta->fetch(PDO::FETCH_ASSOC)){
                                        if ($linha['id'] == $dados['idCidade']) {
                                            echo "<option value='".$linha['idCidade']."' selected>".$linha['nomeCidade']."</option>";
                                        }else{
                        ...
                        <div class='col-4'>
                            ...
                            <textarea name="observacoes" class="form-control" id="observacoes" cols="30" rows="1"><?php if ($acao == 'editar') echo $dados['observacoes'];?></textarea>
                        </div>
